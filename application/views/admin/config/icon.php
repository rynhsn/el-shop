...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <form action="<?= site_url('admin/config/icon/'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm form-group">
                        <img src="<?= base_url('assets/img/' . $config['icon']); ?>" alt="logo" class="img img-responsive img thumbnail" width="200">
                    </div>
                </div>
