...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <a href="<?= base_url('admin/transaction/cancel/' . $trx['id_trx']); ?>" class="btn btn-danger rounded-pill mb-3 ml-3 float-right">Cancel</a>
            <?php if ($trx['status_trx'] == 'Waiting for Confirmation') : ?>
                <a href="<?= base_url('admin/transactions/proccess/' . $trx['id_trx']); ?>" class="btn btn-info rounded-pill mb-3 float-right">Proccess</a>
            <?php elseif ($trx['status_trx'] == 'In Proccess') : ?>
                <a href="<?= base_url('admin/transactions/send/' . $trx['id_trx']); ?>" class="btn btn-info rounded-pill mb-3 float-right">Send Now!</a>
            <?php endif; ?>
        </div>
    </div>
